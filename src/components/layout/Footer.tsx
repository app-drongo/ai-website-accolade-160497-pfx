  ...
  const footerSections = [
      ...
      links: [
        {
          ...
          href: '/recognition',
          editableId: 'link-footer-recognition',
        },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Training Resources', href: '/training', editableId: 'link-footer-training' },
        { name: 'Webinar Series', href: '/webinars', editableId: 'link-footer-webinars' },
        { name: 'Customer Success', href: '/success-stories', editableId: 'link-footer-success' },
